...
const SOURCE_DIR = '/Users/evanward/Documents/AS Portal - New /AS2 Files/Practice Questions-S2-Standard Deviation';
const PACK_PREFIX = 'AS2_mean_standard_deviation';
const OUTPUT_FILE = path.join(SOURCE_DIR, `${PACK_PREFIX}_combined.md`);
const EXPECTED_QUESTIONS = 11;
...
function buildCombinedMarkdown(): void {
  ...
  const chunks: string[] = [
    '# AS2 Mean and Standard Deviation Combined Study Pack',
    '',
