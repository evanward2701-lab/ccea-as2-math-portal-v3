...
const CompareDerivationDiagramsPage: React.FC = () => {
  return (
    <div className="min-h-screen bg-background text-foreground p-8 space-y-16 overflow-y-auto">
      {/* Structural Header Box */}
      <div className="border-b border-border pb-4 max-w-5xl mx-auto">
        <h1 className="text-2xl font-bold tracking-wide">Diagram Variant Comparison</h1>
        <p className="text-sm text-muted-foreground mt-1">Reviewing visual approaches before cleanup phase.</p>
      </div>
