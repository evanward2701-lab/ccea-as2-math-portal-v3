              ...
              <div
                ...
                className={cn(
                  ...
                  relevant
                    ...
                    : "bg-slate-900/20 border-slate-800 opacity-50 grayscale-[0.5]"
                )}
              >
                <div className="flex flex-col">
                  <span className={cn(
                    "text-[10px] font-bold uppercase tracking-widest mb-1",
                    relevant ? "text-emerald-400" : "text-slate-500"
                  )}>
                    {formula.label}
                  </span>
                  <div className={cn(
                    "text-lg sm:text-xl font-bold font-mono",
                    relevant ? "text-slate-100" : "text-slate-400"
                  )}>
                    ...
                    <span
                      ...
                      className={cn(
                        ...
                        selectedKnowns.includes(v)
                          ...
                          : relevant
                            ? "bg-sky-500/20 text-sky-400 border border-sky-500/30 animate-pulse" // This is the unknown one
