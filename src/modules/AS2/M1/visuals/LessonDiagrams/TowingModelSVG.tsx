...
export const TowingModelSVG: React.FC = () => (
  ...
  >
    <div className="relative w-full aspect-76/42 max-w-4xl mx-auto rounded-xl overflow-hidden border border-slate-800/50 bg-slate-950 shadow-[8px_8px_0px_#0f172a]">
      <SVGLibrary />
