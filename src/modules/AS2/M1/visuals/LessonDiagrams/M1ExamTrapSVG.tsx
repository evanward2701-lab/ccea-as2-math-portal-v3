...
export const M1ExamTrapSVG: React.FC = () => (
  <div className="w-full border border-zinc-800/60 bg-[#141416] p-6 rounded-xl my-8 relative overflow-hidden shadow-inner">
    <div className="absolute top-0 right-0 bg-rose-600 text-zinc-50 text-[9px] uppercase tracking-widest font-black px-3 py-1 font-sans">
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-xs">
      ...
      <div className="border border-rose-950/60 bg-rose-950/20 p-4 rounded-lg relative opacity-60">
        ...
        <code className="text-zinc-400 block font-mono text-[10px] bg-[#141416] p-2 rounded tracking-wide mb-3 border border-zinc-800">
          0 = 21 - 9.8t ⇒ t = 2.14s
        </code>
        <span className="block font-bold text-zinc-400 mb-2">Attempt 2: Downwards Positive</span>
        <code className="text-zinc-400 block font-mono text-[10px] bg-[#141416] p-2 rounded tracking-wide border border-zinc-800">
          0 = 21 + 9.8t ⇒ t = -2.14s
        </code>
      ...
      <div className="border border-emerald-900/60 bg-emerald-950/20 p-4 rounded-lg relative">
        ...
        <div className="relative inline-block w-full mb-3">
          ...
          <code className="text-zinc-500 block font-mono text-[10px] bg-[#141416] p-2 rounded tracking-wide line-through decoration-rose-500/80 border border-zinc-800">
            0 = 21 + 9.8t ⇒ t = -2.14s
          </code>
        </div>
        <span className="block font-bold text-zinc-200 mb-2">Active Clean Solution</span>
        <code className="text-emerald-400 block font-mono text-[10px] bg-[#141416] p-2 rounded tracking-wide font-bold border border-emerald-900">
          0 = 21 - 9.8t ⇒ t = 2.14s ✓
        </code>
