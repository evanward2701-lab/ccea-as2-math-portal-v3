  ...
  return (
    ...
    >
      ...
      <div className="w-full max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        {/* CARD 1: PARTICLE */}
        <div className="flex flex-col justify-between bg-zinc-900/10 border border-zinc-800/40 rounded-xl p-5 backdrop-blur-md min-h-85">
          <div>
            <div className="text-zinc-400 font-bold tracking-wider text-2.75 uppercase mb-4 pl-1">
              <MathInline content="$\text{Particle}$" />
            </div>
            <div className="w-full h-24 bg-zinc-925 border border-zinc-800/60 rounded-xl flex items-center justify-center relative overflow-hidden mb-4">
        ...
        <div className="flex flex-col justify-between bg-zinc-900/10 border border-zinc-800/40 rounded-xl p-5 backdrop-blur-md min-h-85">
          ...
          <div className="w-full bg-zinc-925/80 rounded-lg p-2.5 text-center border border-zinc-800/40 text-sm font-bold text-amber-400 shadow-inner">
          ...
          <div>
            ...
            <div className="w-full h-24 bg-zinc-925 border border-zinc-800/60 rounded-xl flex items-center justify-center relative overflow-hidden mb-4">
              <svg viewBox="0 0 200 100" className="w-full h-full">
                ...
                <text x="100" y="54" textAnchor="middle" className="fill-zinc-500 text-2.5 font-black tracking-wider">0 kg</text>
              </svg>
            </div>
            <div className="space-y-2 text-zinc-300 text-xs px-1">
        ...
        <div className="flex flex-col justify-between bg-zinc-900/10 border border-zinc-800/40 rounded-xl p-5 backdrop-blur-md min-h-85">
          ...
          <div className="w-full bg-zinc-925/80 rounded-lg p-2.5 text-center border border-zinc-800/40 text-sm font-bold text-emerald-400 shadow-inner">
        ...
        <div className="flex flex-col justify-between bg-zinc-900/10 border border-zinc-800/40 rounded-xl p-5 backdrop-blur-md min-h-85 lg:col-span-3 lg:max-w-md lg:mx-auto w-full">
          <div>
            <div className="text-zinc-400 font-bold tracking-wider text-2.75 uppercase mb-4 pl-1">
