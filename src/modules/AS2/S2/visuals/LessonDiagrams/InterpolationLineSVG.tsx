  ...
  >
    <div className="flex flex-col items-center space-y-4 w-full">
      <div className="relative w-full aspect-52/20 max-w-lg mx-auto">
        ...
        <DiagramLabel position={{ left: '15.4%', top: '5%' }}><MathText content="5" className="text-xs text-slate-300" /></DiagramLabel>
        <DiagramLabel position={{ left: '42.3%', top: '5%' }}><MathText content="10" className="text-xs font-bold text-sky-400" /></DiagramLabel>
        <DiagramLabel position={{ left: '80.8%', top: '5%' }}><MathText content="17" className="text-xs text-slate-300" /></DiagramLabel>
        ...
        <DiagramLabel position={{ left: '15.4%', top: '67.5%' }}><MathText content="10" className="text-xs text-slate-300" /></DiagramLabel>
        <DiagramLabel position={{ left: '42.3%', top: '67.5%' }}><MathText content="Q_2" className="text-sm font-bold text-emerald-400" /></DiagramLabel>
        <DiagramLabel position={{ left: '80.8%', top: '67.5%' }}><MathText content="20" className="text-xs text-slate-300" /></DiagramLabel>
      </div>
