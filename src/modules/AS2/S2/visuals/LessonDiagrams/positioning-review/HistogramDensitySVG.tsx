      ...
      <div className="space-y-3">
        <div className="p-4 bg-primary/5 border border-primary/20 rounded-lg">
          <p className="text-sm text-foreground leading-relaxed">
            In a histogram, the <strong className="font-semibold text-primary">area</strong> of each bar represents the <strong className="font-semibold text-primary">frequency</strong>, not the height.
          </p>
        </div>
        <div className="p-4 bg-destructive/30 border border-destructive/40 rounded-lg">
          <h4 className="font-bold text-destructive mb-2 text-sm uppercase tracking-wider">CCEA Exam Pitfall</h4>
  ...
  >
    <div className="relative w-full aspect-57/28 max-w-lg mx-auto">
      ...
      <DiagramLabel x="61.4%" y="55%">
        <div className="text-primary text-sm font-semibold tracking-wide bg-card/40 rounded px-2 py-1">
