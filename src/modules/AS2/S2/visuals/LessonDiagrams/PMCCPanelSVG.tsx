...
export const PMCCPanelSVG: React.FC = () => (
  ...
  >
    <div className="flex flex-col items-center bg-zinc-900/50 border border-zinc-800 p-6 rounded-xl shadow-inner max-w-2xl w-full">
      <div className="relative w-full mb-6 flex justify-center items-center h-16 border-b border-zinc-800 pb-4 text-2xl text-emerald-400">
      ...
      <div className="w-full border-b border-zinc-800 mb-6 pb-6">
