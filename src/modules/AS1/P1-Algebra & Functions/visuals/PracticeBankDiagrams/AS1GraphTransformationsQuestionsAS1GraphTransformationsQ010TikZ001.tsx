...
export const AS1GraphTransformationsQuestionsAS1GraphTransformationsQ010TikZ001: React.FC = () => (
  <DiagramPanel title={"Source sketch for C1 June 2014 Question 1(b)"} analysis={null}>
