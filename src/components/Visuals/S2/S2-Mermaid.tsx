...
export const StdDevDecisionTree: React.FC = () => {
  // CRITICAL: The template literal string is completely flush left to guarantee parser compatibility.
...
style N fill:#FAF9F6,stroke:#1A1A1A,stroke-width:2px,color:#1A1A1A
style N1 fill:#FFFFFF,stroke:#1A1A1A,stroke-width:2px,stroke-dasharray: 4 4,color:#1A1A1A

linkStyle 0,1 stroke:#1A1A1A,stroke-width:2px`;
  ...
  return (
    <div className="w-full flex flex-col items-center py-8 mb-12 border border-[#1A1A1A] bg-[#FAF9F6] relative shadow-[8px_8px_0px_#1A1A1A]">
      ...
      <p className="text-[11px] font-sans text-[#1A1A1A]/70 text-center mt-2 px-6 italic max-w-prose">
        ...
        Calculators output both versions. Using the wrong one will lose you method and accuracy marks.
      </p>
    </div>
  );
};