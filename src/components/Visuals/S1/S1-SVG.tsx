...
export const SamplingTableSVG: React.FC = () => (
  <div className="w-full flex flex-col items-center py-10 mb-12 border border-slate-800 bg-slate-950 relative shadow-[8px_8px_0px_#0f172a] rounded-xl overflow-hidden">
    ...
    <div className="w-full px-6 mt-6 overflow-x-auto">
      <table className="w-full border-collapse text-sm font-sans bg-slate-950 text-slate-300">
        <thead>
          <tr className="bg-slate-900 text-slate-400 uppercase tracking-wider text-[10px] font-mono border-b-2 border-slate-700">
            <th className="p-4 text-left font-bold w-1/4">Method</th>
            <th className="p-4 text-left font-bold w-1/4">Random Base?</th>
            <th className="p-4 text-left font-bold w-1/4">Primary Advantage</th>
            <th className="p-4 text-left font-bold w-1/4">Primary Disadvantage</th>
          </tr>
        </thead>
        <tbody className="divide-y divide-slate-800">
          <tr className="hover:bg-slate-900/50 transition-colors">
            ...
            <td className="p-4 text-xs leading-relaxed">Free of bias. Easy and cheap for small populations.</td>
            <td className="p-4 text-xs leading-relaxed">Requires a full sampling frame. Not suitable for large populations.</td>
          </tr>
          <tr className="hover:bg-slate-900/50 transition-colors">
            <td className="p-4 font-bold text-sky-400">Systematic</td>
            <td className="p-4"><span className="text-emerald-400 font-mono text-[10px] border border-emerald-500/30 bg-emerald-500/10 px-2 py-1 rounded">YES</span></td>
            <td className="p-4 text-xs leading-relaxed">Simple and quick to use. Suitable for large samples.</td>
            <td className="p-4 text-xs leading-relaxed">A sampling frame is still needed. Can introduce bias if the frame has periodic traits.</td>
          </tr>
          <tr className="hover:bg-slate-900/50 transition-colors">
            <td className="p-4 font-bold text-sky-400">Stratified</td>
            <td className="p-4"><span className="text-emerald-400 font-mono text-[10px] border border-emerald-500/30 bg-emerald-500/10 px-2 py-1 rounded">YES</span></td>
            <td className="p-4 text-xs leading-relaxed">Accurately reflects population structure. Guarantees proportional representation.</td>
            <td className="p-4 text-xs leading-relaxed">Population must be naturally divisible into distinct strata.</td>
          </tr>
          <tr className="hover:bg-slate-900/50 transition-colors bg-slate-900/20">
            ...
            <td className="p-4 text-xs leading-relaxed">Allows a small sample to be representative. No sampling frame required.</td>
            <td className="p-4 text-xs leading-relaxed">Can introduce interviewer bias. Non-random selection negates advanced statistical tests.</td>
          </tr>
          <tr className="hover:bg-slate-900/50 transition-colors bg-slate-900/20">
            <td className="p-4 font-bold text-amber-500">Opportunity / Convenience</td>
            <td className="p-4"><span className="text-rose-400 font-mono text-[10px] border border-rose-500/30 bg-rose-500/10 px-2 py-1 rounded">NO</span></td>
            <td className="p-4 text-xs leading-relaxed">Easy to carry out. Inexpensive.</td>
            <td className="p-4 text-xs leading-relaxed">Highly unlikely to provide a representative sample. Highly dependent on researcher bias.</td>
          </tr>
        </tbody>
      </table>
    </div>

    <p className="text-[11px] font-sans text-slate-400 text-center mt-6 px-6 italic">
      <strong className="text-rose-400 not-italic uppercase text-[10px]">CCEA Exam Pitfall:</strong> Do not confuse Stratified and Quota sampling. Stratified sampling selects elements *randomly* within each strata (requiring a sampling frame). Quota sampling does not use random selection.
    </p>
  </div>
);
export const StratifiedProportionVisual: React.FC = () => (
  <div className="w-full flex flex-col items-center py-10 mb-12 border border-slate-800 bg-slate-950 relative shadow-[8px_8px_0px_#0f172a] rounded-xl overflow-hidden">
    ...
    <svg width="600" height="220" viewBox="0 0 600 220" fill="none" xmlns="http://www.w3.org/2000/svg" shapeRendering="geometricPrecision">
      <defs>
