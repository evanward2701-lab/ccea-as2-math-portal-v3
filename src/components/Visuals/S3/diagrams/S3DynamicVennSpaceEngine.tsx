    ...
    >
      <div className="w-full flex flex-col items-center">
        ...
        <div className="relative w-full aspect-56/32 max-w-2xl mx-auto">
          ...
          {!isMutuallyExclusive && (
            <DiagramLabel position={{ left: '50%', top: '50%' }} className="-translate-x-1/2 -translate-y-1/2">
              <div className="text-sky-400 text-sm font-bold"><MathText content="A \cap B" /></div>
            </DiagramLabel>
          )}
