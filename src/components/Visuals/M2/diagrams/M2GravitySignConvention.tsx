  ...
  return (
    ...
    >
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 w-full max-w-4xl items-center">
        ...
        <div className="flex flex-col items-center justify-center bg-slate-900/50 p-6 rounded-lg border border-slate-800 h-full relative">
          <div className="relative w-full max-w-[160px] aspect-18/22 select-none">
            ...
            <DiagramLabel position={{ left: '50%', top: '5%' }}>
              <div className="text-sm font-bold uppercase tracking-wider text-slate-500 text-center w-32">Physical Direction</div>
            </DiagramLabel>
        ...
        <div className="flex flex-col gap-4">
           ...
           <div className="bg-slate-950 border border-slate-800 p-4 rounded-lg flex items-center gap-6 relative">
              ...
              <div className="flex-1">
                <h5 className="text-sm font-bold text-slate-200 mb-1">Convention: Up is Positive</h5>
                <div className="bg-slate-900/80 px-3 py-2 rounded font-mono text-emerald-400 text-sm border border-emerald-500/20">
                  a = -9.8
                </div>
                <p className="text-[10px] text-slate-500 mt-2 italic">Standard for projectiles launched from ground.</p>
              </div>
           </div>
           ...
           <div className="bg-slate-950 border border-slate-800 p-4 rounded-lg flex items-center gap-6 relative">
              ...
              <div className="flex-1">
                <h5 className="text-sm font-bold text-slate-200 mb-1">Convention: Down is Positive</h5>
                <div className="bg-slate-900/80 px-3 py-2 rounded font-mono text-amber-400 text-sm border border-amber-500/20">
                  a = +9.8
                </div>
                <p className="text-[10px] text-slate-500 mt-2 italic">Standard for objects dropped from height.</p>
              </div>
           </div>
        </div>
      </div>
