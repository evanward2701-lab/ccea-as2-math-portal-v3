        ...
        >
          ...
          <g transform="translate(30, 20)">
            ...
            <foreignObject x="0" y="0" width="40" height="30">
              <MathText content="v" className="text-slate-400 text-sm" />
            </foreignObject>
            <foreignObject x="210" y="165" width="20" height="30">
              <MathText content="t" className="text-slate-400 text-sm" />
            </foreignObject>
            <line x1="20" y1="160" x2="200" y2="160" stroke="#f43f5e" strokeWidth="4" strokeLinecap="round" />
            <foreignObject x="40" y="80" width="160" height="50">
              <div className="text-center p-1 bg-slate-900/80 border border-rose-950 rounded text-xs text-rose-400 font-medium">
          ...
          <g transform="translate(330, 20)">
            ...
            <line x1="20" y1="70" x2="200" y2="70" stroke="#f59e0b" strokeWidth="4" strokeLinecap="round" />
            <foreignObject x="40" y="85" width="160" height="65">
              <div className="text-center p-1 bg-slate-900/80 border border-amber-950 rounded text-xs text-amber-400 font-medium">
                Constant Velocity (<MathText content="a = 0" />)<br />
                <span className="text-[10px] text-slate-400 italic">Pitfall: Object is moving, not stationary!</span>
              </div>
            </foreignObject>
          </g>
          ...
          <g transform="translate(630, 20)">
            ...
            <line x1="20" y1="160" x2="200" y2="40" stroke="#10b981" strokeWidth="4" strokeLinecap="round" />
            <foreignObject x="40" y="70" width="160" height="50">
              <div className="text-center p-1 bg-slate-900/80 border border-emerald-950 rounded text-xs text-emerald-400 font-medium">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 items-center">
          <div className="md:col-span-2">
            <svg 
              ...
              shapeRendering="geometricPrecision"
            >
              <polygon points="50,200 290,50 530,200" fill="url(#m2EmeraldGrad)" opacity="0.15" />
              ...
              <line x1="290" y1="50" x2="290" y2="200" stroke="#475569" strokeWidth="1.5" strokeDasharray="4 4" />
              ...
              <foreignObject x="15" y="40" width="35" height="30">
                <MathText content="V" className="text-emerald-400 font-bold text-right" />
              </foreignObject>
              ...
              <foreignObject x="220" y="110" width="180" height="40">
                <div className="text-center text-xs text-emerald-400 font-bold bg-slate-950/90 py-1 px-2 border border-emerald-500/20 rounded">
          ...
          <div className="bg-slate-900 border border-slate-800 p-4 rounded-lg space-y-2">
            <h5 className="text-xs font-bold text-slate-300 uppercase tracking-wider">Symmetry Alert</h5>
...
export const M2GravitySignConvention: React.FC = () => {
  return (
    <div className="w-full bg-slate-900/40 p-5 rounded-xl border border-slate-800/80 my-2">
      <div className="flex flex-col md:flex-row items-center justify-between gap-6">
        <div className="w-full md:w-2/5 space-y-2">
          ...
          <div className="p-2 bg-rose-950/30 border border-rose-900/40 rounded text-[11px] text-rose-300">
        ...
        <div className="w-full md:w-3/5 flex justify-center bg-slate-950 p-4 rounded-lg border border-slate-900">
          <svg 
            viewBox="0 0 500 180" 
            className="w-full max-w-125 h-auto select-none"
            shapeRendering="geometricPrecision"
          >
            {/* PHYSICS DIRECTIVE */}
            ...
            <g transform="translate(180, 10)">
              <rect x="0" y="0" width="140" height="145" rx="6" fill="#090d16" stroke="#1e293b" />
              <text x="10" y="20" fill="#94a3b8" className="text-[9px] font-bold uppercase">Setup A: Upwards +</text>
              <line x1="30" y1="115" x2="30" y2="45" stroke="#10b981" strokeWidth="2" strokeDasharray="2 2" />
            ...
            <g transform="translate(340, 10)">
              ...
              <line x1="30" y1="45" x2="30" y2="115" stroke="#f59e0b" strokeWidth="2" strokeDasharray="2 2" />
    ...
    <div className="w-full bg-slate-900 border border-amber-500/20 bg-linear-to-b from-slate-900 to-slate-950 p-5 rounded-xl shadow-xl my-4">
      <div className="flex flex-col lg:flex-row items-center gap-6">
        <div className="w-full lg:w-1/2 space-y-3">
          ...
          <p className="text-xs text-slate-400 leading-relaxed">
            If a 2D vector kinematics question specifically requests the scalar <strong>distance</strong> between two coordinate vectors, calculating the displacement expression <MathText content="\mathbf{s} = x\mathbf{i} + y\mathbf{j}" /> is an uncompleted step. You must calculate the modulus vector magnitude to close the question loop.
          </p>
        ...
        <div className="w-full lg:w-1/2 bg-slate-950/40 p-4 rounded-lg border border-slate-900/60 flex justify-center">
          <svg 
            viewBox="0 0 320 200" 
          ...
          >
            ...
            <foreignObject x="60" y="70" width="100" height="35">
              <div className="text-[11px] font-bold text-emerald-400 bg-slate-900 px-1 py-0.5 border border-emerald-500/20 rounded text-center shadow-lg">
